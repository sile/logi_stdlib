...
new_test_() ->
    [
     {"Creates a layout instance",
      fun () ->
              Layout0 = logi_layout_newline:new(logi_layout_io_lib_format:new()),
              ?assert(logi_layout:is_layout(Layout0)),

              Layout1 = logi_layout_newline:new(logi_layout_io_lib_format:new(), lf),
              ?assert(logi_layout:is_layout(Layout1)),

              Layout2 = logi_layout_newline:new(logi_layout_io_lib_format:new(), cr),
              ?assert(logi_layout:is_layout(Layout2)),

              Layout3 = logi_layout_newline:new(logi_layout_io_lib_format:new(), crlf),
              ?assert(logi_layout:is_layout(Layout3))
      end},
     {"[ERROR] Invalid argument",
      fun () ->
              ?assertError(badarg, logi_layout_newline:new(123)), % Not a layout
              ?assertError(badarg, logi_layout_newline:new(logi_layout_io_lib_format:new(), hoge)) % Undefined style
      end}
    ].
    ...
    [
     {"Formats log messages",
      fun () ->
              ...
              Base = logi_layout_io_lib_format:new(),
